$(function () {
    $.post('/user/inspector/', {}, function (result) {
        var select = $('#page12_jComboBox1_select');
        if (result.code === 200){
    ...
    $('#page12_jButton1').click(function () {
        var formData = new FormData();
        var product_id = $('#page12_jEdit1').val();
        var name = $('#page12_jEdit7').val();
        var batch_id = $('#page12_jEdit6').val();
        var desc = $('#page12_jEdit8').val();
        var inspector_id = $('#page12_jComboBox1_select').val();
